...
export const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      ref={heroRef}
      className=" relative min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 overflow-hidden pt-10"
    >
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div  className="flex justify-center lg:justify-end px-4">
            <div className="relative w-[550px] h-[550px]">
              {/* Glowing circle centered behind image */}
              <div
                className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 
                    w-[420px] h-[420px] rounded-full 
                    bg-gradient-to-br from-cyan-400 to-blue-500 opacity-20"
              ></div>

              {/* Image Container */}
              <div ref={carRef} className="relative z-10 w-full h-full flex items-center justify-center p-4 dark:text-cyan-400">
                <img
                  src="./hero.png"
                  alt="Hero"
